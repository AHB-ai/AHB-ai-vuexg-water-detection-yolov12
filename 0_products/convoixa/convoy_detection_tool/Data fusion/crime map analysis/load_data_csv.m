function data = load_data_csv(filename, rows)
% data = load_ANPR_data_csv(filename, rows, number_columns)
...
% rows: a index vecor of rows to be read (default: 'all')
% number_columns: number of files of each row of ANPR data
%                (default: automatically detected)
%
% Output argument:
% data = 2-D cell array of data in the CSV file, each of whose element is a
%        string representing a cell in comma-separated value in the file
%
...
% Automatically determine the number of columns by reading the first row of
% the CSV file.
