function [flag_convoy, mat_score_time] = compareTrajectory(val_seed, len_seed, val, len, ~, camMap, session_break)
...
flag = ismember(anpr_seed, anpr);

if sum(flag)/len_seed>0.5
